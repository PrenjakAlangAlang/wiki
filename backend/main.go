...
middleware.DB = db
	...
	r.Handle("/api/content/delete/{id}", middleware.JWTAuth(middleware.RoleAuthMiddleware("delete_content", http.HandlerFunc(contentcontroller.DeleteContent)))).Methods("DELETE")
